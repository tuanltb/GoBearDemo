...
public class GoBearTestNG {
	...
	public void testTravelInsurance() throws InterruptedException {
		 ...
		 * 3 categories: Filter, Sort and Details. 
		 * Basic goal: test at least 1 option per option (Filter, Sort, Details) changing at least 1 radio button, 1 range
		 * selector, 1 check box, 1 dropdown, 1 calendar picker. 
		 * Stretch goal*: write a test to ensure the left side menu is functional.
		 */
		...
		List<WebElement> cardsListSorted = driver.findElements(By.xpath("//div[@class='policy-price']//span[@class='value']"));		
